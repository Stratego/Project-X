...
/**
 * Gestiona el content provider de la tabla que relaciona jugadores y roles.
 */
public class JugadorRolMinion extends MinionContentProvider {
    ...
    public Cursor query(SQLiteDatabase db, Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        queryBuilder.setTables(
                tbJugadores.TABLE+" JOIN "+tbJugadorRol.TABLE+" ON "+ tbJugadores._ID+" = "+tbJugadorRol.COL_JUGADOR
        );
